...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/last.pt', help='weights path')                  # when train.py is run, it creates the model/weights file last.pt.. this is used for detection here..
